...
def compute_term_burstiness(df, timestamp_index, target_index, long_ma_length, short_ma_length, significance_ma_length, signal_line_ma):
    # Build a vocabulary
    ...
    grouped_df = df.groupby(df.columns[timestamp_index])
    ...
    for key, item in grouped_df:
        ...
        time_stamp = a_group.iloc[:, timestamp_index].tolist()[0]
...
def topic_modeling(burstiness, df, timestamp_index, target_index):
