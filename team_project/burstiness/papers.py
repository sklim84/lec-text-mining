...
# 데이터 로드
df = papers_data.load_for_burstiness(timestamp_index=1, target_index=3)
...
burstiness_over_time.to_csv(
    './results/papers_bursty_terms_over_time_{}_{}_{}_{}.csv'.format(short_ma_length, long_ma_length, signal_line_ma,
                                                                   significance_ma_length),
    encoding='utf-8-sig')
# term bustiness 계산 결과 csv 저장
# - 결과 형식 : terms | max value | location(month)
burstiness.to_csv('./results/papers_bursty_terms_{}_{}_{}_{}.csv'.format(short_ma_length, long_ma_length, signal_line_ma,
                                                                       significance_ma_length),
                  encoding='utf-8-sig')
...
df_clusters.to_csv(
    './results/papers_bursty_clusters_{}_{}_{}_{}.csv'.format(short_ma_length, long_ma_length, signal_line_ma,
                                                            significance_ma_length), index=False, encoding='utf-8-sig')

# plot clusters
output_filename = './results/papers_bursty_clusters_{}_{}_{}_{}.png'.format(short_ma_length, long_ma_length,
