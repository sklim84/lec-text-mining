...
from study._datasets import jpss_data
from study.topic_modeling.dmr.commons import dmr_model, topic_scoring, get_topic_labeler
...
if reuse_trained_model:
    ...
    # 데이터 로드 및 전처리
    timestamps, dataset = jpss_data.load_for_dmr(timestamp_index=1, target_index=3)
