...
def read_english_corpus():
    ...
    _train_negative_docs = ptm.CorpusFromFile('../sample_data/datasets/twitter/train-neg.txt')
    _train_negative_docs = _train_negative_docs.docs[:5000]
    _train_positive_docs = ptm.CorpusFromFile('../sample_data/datasets/twitter/train-pos.txt')
    _train_positive_docs = _train_positive_docs.docs[:5000]
    _test_negative_docs = ptm.CorpusFromFile('../sample_data/datasets/twitter/test-neg.txt')
    _test_negative_docs = _test_negative_docs.docs[:5000]
    _test_positive_docs = ptm.CorpusFromFile('../sample_data/datasets/twitter/test-pos.txt')
...
def read_korean_corpus():
    ...
    corpus = ptm.CorpusFromFieldDelimitedFileForClassification('../sample_data/ratings.txt', doc_index=1, class_index=2)
...
if customized == True:
    ...
    sentiAnalyzer.save(model, model_name='sentiment.model')
